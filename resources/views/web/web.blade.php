...
<main>
    ...
    <div class="slider-area ">
        <div class="slider-active">
            ...
            <div class="single-slider slider-height d-flex align-items-center">
                    ...
                    <div class="row">
                        <div class="col-xl-7 col-lg-7 col-md-8">
                            <div class="hero__caption">
                                <span data-animation="fadeInUp" data-delay=".4s">GAME</span>
                                <h1 data-animation="fadeInUp" data-delay=".6s">GAME</h1>
                                <!-- Hero-btn -->
                                <div class="hero__btn">
                                    <a href="industries.html" class="btn hero-btn"  data-animation="fadeInLeft" data-delay=".8s">VISIT SITE</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Hero Man Img -->
                <div class="hero-man">
                    <img src="{{asset('assets/img/hero/hero_man1.png')}}" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="about-area about1 section-padding30">
        ...
        <div class="about-shape d-none d-xl-block">
            <img src="{{asset('assets/img/gallery/about_shape.png')}}" alt="">
        </div>
    </section>
    <!-- Services Area End -->
    <!--? Blog Ara Start -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <img src="{{asset('assets/img/gallery/blog03.png')}}" alt="">
                        </div>
                        <div class="team-caption">
        ...
        <div class="container-fluid p-0">
            <div class="row no-gutters">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                    <div class="gallery-box">
                        <div class="single-gallery">
                            <div class="gallery-img" style="background-image: url({{asset('assets/img/gallery/csgo.jpg')}});"></div>
                            <div class="cap-icon">
                                <a href="{{asset('assets/img/gallery/csgo.jpg')}}" class="ti-fullscreen img-pop-up"></a>
                            </div>
                            <div class="g-caption">
                                <h4>CSGO</h4>
                                <!-- <p>Duis aute irure dolor in reprehenderit in voluptate velit.</p> -->
                ...
                <!-- <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div class="gallery-box">
                        <div class="single-gallery">
                            <div class="gallery-img" style="background-image: url({{asset('assets/img/gallery/valorant.jpg')}});"></div>
                            <div class="cap-icon">
                                <a href="{{asset('assets/img/gallery/valorant.jpg')}}" class="ti-fullscreen img-pop-up"></a>
                            </div>
                            <div class="g-caption">
                                <h4>Valorant</h4>
                                <p>Duis aute irure dolor in reprehenderit in voluptate velit.</p> 
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                    <div class="gallery-box">
                        <div class="single-gallery">
                            <div class="gallery-img" style="background-image: url({{asset('assets/img/gallery/pubg.jpg')}});"></div>
                            <div class="cap-icon">
                                <a href="{{asset('assets/img/gallery/pubg.jpg')}}" class="ti-fullscreen img-pop-up"></a>
                            </div>
                            <div class="g-caption">
                                <h4>PubG</h4>
                                <!-- <p>Duis aute irure dolor in reprehenderit in voluptate velit.</p> -->
                ...
                <!-- <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                    <div class="gallery-box">
                        <div class="single-gallery">
                            ...
                            <div class="cap-icon">
                                <a href="{{asset('assets/img/gallery/gallery5.png')}}" class="ti-fullscreen img-pop-up"></a>
                            </div>
                            <div class="g-caption">
                                <h4>The Last man</h4>
                                <p>Duis aute irure dolor in reprehenderit in voluptate velit.</p>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                    <div class="gallery-box">
                        <div class="single-gallery">
                            <div class="gallery-img" style="background-image: url({{asset('assets/img/gallery/gtav.jpg')}});"></div>
                            <div class="cap-icon">
                                <a href="{{asset('assets/img/gallery/gtav.jpg')}}" class="ti-fullscreen img-pop-up"></a>
                            </div>
                            <div class="g-caption">
                                <h4>GTA V</h4>
                                <!-- <p>Duis aute irure dolor in reprehenderit in voluptate velit.</p> -->
    ...
    <section class="brand-area pb-bottom section-padding30">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="single-brand text-center mb-30">
                        <img src="{{asset('assets/img/gallery/brand02.png')}}" alt="">
                        <p>Behance award</p>
                        <p>Prize 2019</p>
                    </div>
                </div>
        ...
        <div class="brand-shape d-none d-lg-block">
            <img src="{{asset('assets/img/gallery/brand_shape.png')}}" alt="">
        </div>
    </section>
    <!-- Brand Area End -->  
    <!--? Testimonial Start -->
